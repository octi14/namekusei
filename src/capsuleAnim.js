...
export function defaultClips() {
  ...
  return {
    ...
    crouchWalk: clip(1.1, [
      { u: 0, pose: P({ legL: [-1.35, 0, 0.08], legR: [-0.75, 0, -0.08], kneeL: [1.25, 0, 0], kneeR: [1.55, 0, 0], armL: [-0.15, 0, 0.3], armR: [0.5, 0, -0.3], elbowL: [-0.9, 0, 0], elbowR: [-0.9, 0, 0], torso: [0.34, 0, 0], head: [-0.3, 0, 0] }) },
      { u: 0.5, pose: P({ legL: [-0.75, 0, 0.08], legR: [-1.35, 0, -0.08], kneeL: [1.55, 0, 0], kneeR: [1.25, 0, 0], armL: [0.5, 0, 0.3], armR: [-0.15, 0, -0.3], elbowL: [-0.9, 0, 0], elbowR: [-0.9, 0, 0], torso: [0.34, 0, 0], head: [-0.3, 0, 0] }) },
    ]),
    charge: clip(2.2, [
