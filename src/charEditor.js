...
const LOOK_COLORS = [
  ...
  ["belt", "Cinturón placa", (l) => l.belt ?? l.trim ?? 0x3e2723],
...
const SLIDERS = [
  ...
  ["shoulderAttachSy", "Hombro unión alto", 0.03, 0.28, 0.005],
  ["shoulderAttachSz", "Hombro unión prof.", 0.1, 2.2, 0.02],
  ...
  ["torsoNeckSx", "Cuello/hombros ancho", 0.4, 2.4, 0.01],
  ...
  ["giLapelY", "Solapas gi pos. Y", -0.35, 0.35, 0.005],
  ["giLapelZ", "Solapas gi Z", -0.25, 0.35, 0.005],
  ["giLapelTilt", "Solapas gi inclinación", -1, 0.9, 0.01],
  ["giLapelSx", "Solapas gi ancho", 0.3, 2.2, 0.02],
  ["giLapelSy", "Solapas gi alto", 0.3, 2.2, 0.02],
  ["giLapelSz", "Solapas gi prof.", 0.3, 2.2, 0.02],
  ...
  ["showFrontFlap", "Faldón delantero on", 0, 1, 1],
  ["frontFlapX", "Faldón front X", -0.2, 0.2, 0.005],
  ["frontFlapY", "Faldón front Y", -0.35, 0.35, 0.005],
  ["frontFlapZ", "Faldón front Z", -0.2, 0.25, 0.005],
  ["frontFlapSx", "Faldón front ancho", 0.4, 2.2, 0.05],
  ["frontFlapSy", "Faldón front alto", 0.4, 2.2, 0.05],
  ["frontFlapSz", "Faldón front grosor", 0.4, 3, 0.05],
  ...
  ["platePecY", "Pechera pecs Y", -0.2, 0.2, 0.005],
  ...
  ["padTilt", "Hombreras inclinación", -1, 0.7, 0.01],
  ["padPitch", "Hombreras pitch", -0.35, 0.45, 0.01],
  ["padArch", "Hombreras cúpula", 0.25, 1.4, 0.02],
  ...
  ["frostLineSx", "Frost línea ancho", 0.3, 3, 0.01],
  ["frostLineSy", "Frost línea alto", 0.3, 3, 0.01],
  ["frostLineSz", "Frost línea prof.", 0.3, 3, 0.01],
  ["frostGemX", "Frost gema X", -0.25, 0.25, 0.005],
  ["frostGemY", "Frost gema Y", -0.35, 0.35, 0.005],
  ["frostGemZ", "Frost gema Z", -0.25, 0.25, 0.005],
  ...
  ["collarY", "Aro cuello Y", -0.2, 0.2, 0.005],
  ["collarThick", "Aro cuello grosor", 0.4, 2.2, 0.05],
  ["collarFit", "Aro cuello holgura", 0, 0.35, 0.01],
  ...
  ["mouthRx", "Boca rot X", -1.5, 1.5, 0.02],
  ["mouthRy", "Boca rot Y", -1.5, 1.5, 0.02],
  ["mouthRz", "Boca rot Z", -3.6, 3.6, 0.02],
